...
echo "[M]: We are analyzing SVs found on ${scaffold} for TE activity."
...
echo ""
echo "[M]: Done RepeatMasker. Beginning filtering of matches..."

python ${pgscripts}/filter_RMoutput_85.py ${fasta}.out ${scaffold}_filtered_svs.fasta ${workdir}/extra_and_error/${scaffold}_below85.out
