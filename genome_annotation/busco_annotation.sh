...
outdir_prim=${home}/genome_annotation/busco_primary_annotation_allv_final
transcripts_prim=${core}/eviann/eviann_int_final/psme_glauca_ann_nopseudo.proteins.fasta
...
module load singularity/3.9.2 blast/2.15.0 augustus/3.6.0 hmmer/3.4 R/4.2.2 java/22 bbmap/39.34 prodigal/2.6.3 busco/6.0.0
