...
transcript_file=${core}/genome_annotation_isoseq_data/test/test_eviann_evidence.txt
protein_db=${core}/genome_annotation_isoseq_data/test/conifer_proteins_test.faa
...
eviann.sh -t 10 -g ${genome} -r ${transcript_file} -p ${protein_db}
