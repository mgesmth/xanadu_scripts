...
#SBATCH -p general
#SBATCH -q general
#SBATCH -D /core/projects/EBP/smith/linkage_actually/11_batchmap_errcorr
#SBATCH -c 24
#SBATCH --mem=128G
#SBATCH --mail-user=meg8130@student.ubc.ca
#SBATCH --mail-type=ALL
#SBATCH -o /core/projects/EBP/smith/linkage_actually/11_batchmap_errcorr/log/%x.%j.out
#SBATCH -e /core/projects/EBP/smith/linkage_actually/11_batchmap_errcorr/log/%x.%j.err
...
dir=${core}/linkage_actually/11_batchmap_errcorr
scripts=${dir}/scripts
if [[ ! -d ${scripts} ]] ; then
