...
LG_cur=LG_list[["LG_1"]]
#last 8 markers
remove=tail(LG_cur$seq.num,n=8)
...
LG_cur=LG_list[["LG_7"]]
#last
remove=tail(LG_cur$seq.num,n=1)
...
LG_cur=LG_list[["LG_9"]]
#first 3, last 3
remove=c(head(LG_cur$seq.num,n=3),tail(LG_cur$seq.num,n=3))
...
save.image("LGs_created_maxrf0.1_LOD15_cleaned.RData")