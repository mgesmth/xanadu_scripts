...
write_onemap_raw(onemap.obj = outcross_clean,file=binned_file)



#batchmap segtest is not expecting an "outcross" object, even though it hass the same structure as
##as onemap object. Here's the function with outcross
...
write_tsv(data.frame(marker=seg_passed),file="seg_passed_markers.tsv")
