...
#SBATCH -p general
#SBATCH -q general
#SBATCH -D /core/projects/EBP/smith/linkage_snp_calling_unsplit/ploidy_estimation_dip
#SBATCH -c 12
#SBATCH --mem=36G
#SBATCH --mail-type=ALL
#SBATCH --mail-user=meg8130@student.ubc.ca
#SBATCH -o /core/projects/EBP/smith/linkage_snp_calling_unsplit/ploidy_estimation_dip/log/%x.%j.out
#SBATCH -e /core/projects/EBP/smith/linkage_snp_calling_unsplit/ploidy_estimation_dip/log/%x.%j.err
...
dir=${topdir}/ploidy_estimation_dip
