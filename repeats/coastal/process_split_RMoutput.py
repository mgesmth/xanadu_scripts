...
out_dir='/home/FCAM/msmith/repeats_coastal/concatenated_results/fa.out_files'
out_files=glob.glob(os.path.join(out_dir,"coastal_scaffold*.fa.out"))
tbl_dir='/home/FCAM/msmith/repeats_coastal/concatenated_results/fa.tbl_files'
tbl_files=glob.glob(os.path.join(tbl_dir,"coastal_scaffold*.fa.tbl"))
merged_out='/home/FCAM/msmith/repeats_coastal/concatenated_results/coastal_repeatMasker_merged.out'
merged_tbl='/home/FCAM/msmith/repeats_coastal/concatenated_results/coastal_repeatMasker_merged.tbl'
...
for file in tbl_files:
    with open(file, "r") as f, open("checkfile.err","w") as af:
        ...
        for line in f:
            #check to see if its a fabricated tbl file for when no repeats were masked
            if "fabricated tbl file for repeat-less contig" in line:
                fab_check=1
            ...
            if fab_check == 1:
                ...
                if elif fields[0] == 'bases' and fields[1] == 'masked:':
                    tbl_values.at['masked_total', 'length'] += int(fields[2])
                    fab_check=0 # done processing file
