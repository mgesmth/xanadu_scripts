...
out_dir='/home/FCAM/msmith/archives/repeats_alternate/concatenated_results/fa.out_files'
out_files=glob.glob(os.path.join(out_dir,"interior_alternate_scaffold*.fa.out"))
tbl_dir='/home/FCAM/msmith/archives/repeats_alternate/concatenated_results/fa.tbl_files'
tbl_files=glob.glob(os.path.join(tbl_dir,"interior_alternate_scaffold*.fa.tbl"))
merged_out='/home/FCAM/msmith/archives/repeats_alternate/concatenated_results/repeatMasker_merged.out'
merged_tbl='/home/FCAM/msmith/archives/repeats_alternate/concatenated_results/repeatMasker_merged.tbl'
