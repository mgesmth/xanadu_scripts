...
cd ${outdir}
singularity exec ${core}/bin/MitoHiFi.sif findMitoReference.py --species "Pseudotsuga menziesii" --outfolder ${outdir}
...
mitohifi.py -p 90 -c ${asm} -f "${relative}.fasta" -g "${relative}.gb" -t 24 -a "plant"
