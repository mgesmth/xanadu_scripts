...
#SBATCH -o pairscaff_hap2.%j.out
#SBATCH -e pairscaff_hap2.%j.err
...
INDEX=${home}/yahs/contigs/intDF011.asm.hic.hap2.p_ctg.fasta
CHROM_SIZES=${home}/yahs/contigs/intDF011.asm.hic.hap2.p_ctg.chrom.sizes
FASTQ1=${home}/hiC_data/allhiC_R1.fastq.gz
FASTQ2=${home}/hiC_data/allhiC_R2.fastq.gz
IN_BAM=${scratch}/aligned_hic_hap2.bam
OUTPREFIX=${scratch}/intDF011_hap2
...
out="intDF011_hap2"
outdir=${core}/scaffold/withpairtools_noec_hap2
bam="${NODUPS_SAM_PATH}"
...
quast_out=${home}/quast_out/1_3_alternate

yahs --no-contig-ec -l 10 -e GATC,GANTC -o ${outdir}/${out} ${INDEX} ${bam}

quast.py -t 12 --split-scaffolds --large -o $quast_out ${outdir}/intDF011_hap2_scaffolds_final.fa
